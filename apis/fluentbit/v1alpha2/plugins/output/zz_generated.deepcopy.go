...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OracleLogAnalytics) DeepCopyInto(out *OracleLogAnalytics) {
	*out = *in
	if in.Auth != nil {
	...
	if in.LogEntityId != nil {
		in, out := &in.LogEntityId, &out.LogEntityId
		*out = new(string)
		**out = **in
	}
	if in.LogEntityType != nil {
		in, out := &in.LogEntityType, &out.LogEntityType
		*out = new(string)
		**out = **in
	}
	if in.LogPath != nil {
	...
	if in.GlobalMetadata != nil {
		in, out := &in.GlobalMetadata, &out.GlobalMetadata
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.LogEventMetadata != nil {
		in, out := &in.LogEventMetadata, &out.LogEventMetadata
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OracleLogAnalytics.
func (in *OracleLogAnalytics) DeepCopy() *OracleLogAnalytics {
	if in == nil {
		return nil
	}
	out := new(OracleLogAnalytics)
	in.DeepCopyInto(out)
	return out
}
